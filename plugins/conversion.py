...
rho_0 = 1.22500  # density at sea level (kg/m3)
p_0 = 101325  # pressure at sea level (Pa)
a_0 = 340.294  # sound speed at sea level (m/s)
gamma = 1.40  # heat capacity ratio
...
v_cas = aero.tas2cas(450, 35000 * aero.ft)
print(aero.ft)
print('v_cas is ', v_cas)
print (tas2cas(450, 23842.3, 0.574937))